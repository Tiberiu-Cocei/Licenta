...
public class DiscountServiceImpl implements DiscountService {
            ...
            for (City city : cityList) {
                ...
                for (Station station : stationList) {
                    ...
                    if(predictedActivity != null) {
                        ...
                        if(Math.abs(difference) > (int)(station.getMaxCapacity()*(2.5f / 100.0f))) {
                            if(difference > 0) {
                ...
                createDiscountsAndTransports(positiveDifference, negativeDifference, staffList, settings, false);
            }
        }
    }
    ...
    private void createDiscountsAndTransports(HashMap<Station, Integer> positiveDifference,
        ...
        for(Map.Entry<Station, Integer> positivePair : positiveDifference.entrySet()) {
            int maxValueForDiscount = (int)(positivePair.getKey().getMaxCapacity() * 0.2);
        ...
        if(!forceDiscounts) {
            createDiscountsAndTransports(positiveDifference, negativeDifference, staffList, settings, true);
        }
    }
